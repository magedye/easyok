    ...
    - generic [ref=e12]:
      ...
      - generic [ref=e17]:
        ...
        - textbox "Question" [ref=e18]:
          ...
          - text: Governance contract test
        - button "Ask" [ref=e20] [cursor=pointer]: اسأل
        - generic [ref=e21]: Governance contract test
    ...
    - alert [ref=e23]:
      ...
      - generic [ref=e42]:
        ...
        - link "الدعم الفني" [ref=e46] [cursor=pointer]:
          - /url: "mailto:support@example.com?subject=Error Report&body=Trace ID: 63aef90642ea4e8982e7573f26af2906%0AError: Stream%20ended%20with%20error%20chunk"
          - img [ref=e47]
          - text: الدعم الفني
```